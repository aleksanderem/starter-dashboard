...
export const CommandMenuFooter = ({ className }: CommandMenuFooterProps) => (
    <footer
        style={{ background: '#F0F0F0', zIndex: 10 }}
        className={cx(
            "absolute inset-x-0 bottom-0 flex items-center justify-between gap-x-3 p-2 pl-4.5 ring-1 ring-secondary_alt max-md:hidden",
            className,
        )}
    >
